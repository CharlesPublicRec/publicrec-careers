<div class="text-white sm:w-7/12">
	<h1 class="text-4xl mt-12 mb-5">Full Stack Developer</h1>
	<p class="text-xl mt-12">Overview</p>
	<p class="mt-3">
		...
		functionality across our website. Our ideal candidate will thrive in a collaborative environment
		...
		<br />
		<br />
		This is a remote role based in the U.S. Our office is located in Chicago if there is interest in
		visiting or working from there.
		<br />
		<br />
		We are committed to building a diverse and inclusive environment at Public Rec. Please submit
		resumes to careers@publicrec.com.
	</p>
</div>
