...
<div class="text-black mb-14">
	...
	<div class=" flex flex-col sm:flex-row mt-2 mb-10 sm:mb-32">
		<div>
			...
			<p class="sm:max-w-[750px] text-[16px] sm:text-[20px] font-light leading-8 sm:leading-9">
			...
			<ul
				class="sm:max-w-[750px] text-[16px] sm:text-[20px] list-disc list-inside font-light
