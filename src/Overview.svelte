<div class="text-white mb-14">
	...
	<div class="max-w-prose flex flex-col sm:flex-row mt-2 mb-10 sm:mb-32">
		<div class="mw-">
			...
			<p class="sm:max-w-[553px] text-sm sm:text-lg font-light leading-8 sm:leading-9">
			...
			<ul
				class="sm:max-w-[553px] text-sm sm:text-lg list-disc list-inside font-light leading-8
				sm:leading-9">
