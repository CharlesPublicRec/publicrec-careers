	...
	<div class="container hidden sm:flex flex-grow justify-between">
		<div class="sm:w-7/12">
			...
			<p class="text-[16px] sm:text-[20px] mt-3">
				...
				growing rapidly and looking for our seventeenth employee. We’re seeking an experienced
				Design Lead to join our creative team.
				<br />
				<br />
				Reporting to our Creative Director, this role will contribute to and lead a wide range of
				design projects across a broad range of media.
				<br />
				<br />
